                    ...
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4"><img class="card-img-top" src=<?php echo base_url().'assets/uploads/files/'. $blj -> gambar?> alt="Card image cap"></div>
                                    <div class="com-md-8">
                                    <table>
                                        <tr>
                                            <td>Nama Produk: </td>
                                            <td><strong><?php echo $blj -> deskripsi?></strong></td>
                                        </tr>
                                        <tr>                                        <tr>
                                            <td>Stok: </td>
                                            <td><strong><?php echo $blj -> stok?></strong></td>
                                        </tr>
                                        <tr>
                                            <td>Harga: </td>
                                            <td><strong><div class="btn btn-sm btn-success"><?php echo $blj -> harga?></div></strong></td>
                                        </tr>
                                    </table>
                                    </div>
                                </div>

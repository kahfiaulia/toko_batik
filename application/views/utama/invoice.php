                        ...
                        <table class="table table-bordered table-hover table- table-striped">
                            ...
                            <?php foreach ($invoice as $inv): ?>
                                <tr>
                                    ...
                                    <td><?php echo $inv -> nama_plg?></td>
                                    <td><?php echo $inv -> alamat_plg?></td>
                                    <td><?php echo $inv -> tgl_pesan?></td>
                                    <td><?php echo $inv -> batas_bayar?></td>
                                    <td><?php echo anchor('utama/invoice/detail/'.$inv->id_invoice, '<div class="btn btn-sm btn-primary">Detail</div>')?></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                    </div>

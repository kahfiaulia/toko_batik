                    ...
                    <div class="container-fluid">
                        ...
                        <div class="table-responsive">
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									<?php foreach ($laporan_tahunan as $laporan_tahunan): ?>
									<tr>
										<td width="150">
											<?php echo $laporan_tahunan->no_transaksi ?>
										</td>
										<td>
											<?php echo $laporan_tahunan->total_harga ?>
										</td>
										<td>
											<?php echo $laporan_tahunan->id_keranjang ?>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
